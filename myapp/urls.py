...
urlpatterns = [
    ...
    path('api/upcoming/', views.api_upcoming_reminders, name='api_upcoming_reminders'),
    ...
    path('api/upcoming-reminders/', views.api_upcoming_reminders, name='api_upcoming_reminders'),
    path('api/mark-notified/<int:reminder_id>/', views.api_mark_notified, name='api_mark_notified'),
]