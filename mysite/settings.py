...
SECRET_KEY = 'django-insecure-1powj=phq&o20#^i02$k5iz-#ns4mp-+=-xb40uo&6(7e25062'
...
# TIME_ZONE for India (IST = UTC+05:30)
TIME_ZONE = 'Asia/Kolkata'

USE_I18N = True

USE_TZ = True  # CRITICAL: Must be True to enforce timezone-aware datetimes
